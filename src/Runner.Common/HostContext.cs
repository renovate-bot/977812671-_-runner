...
namespace GitHub.Runner.Common
{
    ...
    public sealed class HostContext : EventListener, IObserver<DiagnosticListener>, IObserver<KeyValuePair<string, object>>, IHostContext, IDisposable
    {
        ...
        private readonly List<ProductInfoHeaderValue> _userAgents = new()
{
    new ProductInfoHeaderValue(
        $"GitHubActionsRunner-{BuildConstants.RunnerPackage.PackageName.Replace('/', '_')}",
        BuildConstants.RunnerPackage.Version.Replace('/', '_')
    )
};
        ...
        public void LoadDefaultUserAgents()
        {
            ...
            string commitHash = BuildConstants.Source.CommitHash.Replace('/', '_');
            _userAgents.Add(new ProductInfoHeaderValue("CommitSHA", commitHash));
